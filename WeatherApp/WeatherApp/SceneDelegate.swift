...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        guard
            ...
            let masterVC = leftNavVC.viewControllers.first as? WeatherTableViewController,
            let detailVC = (splitVC.viewControllers.last as? UINavigationController)?.topViewController as? WeatherDetailViewController
            else { return }
        
        detailVC.weather = masterVC.weatherDetails
